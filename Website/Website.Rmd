...
```{r child = '../rmds/research_compendium.Rmd'}
```

```{r child = '../rmds/open.Rmd'}
```

```{r child = '../rmds/drake.Rmd'}
```

```{r child = '../rmds/procedure.Rmd', eval = TRUE}
```

```{r child = '../rmds/discussion.Rmd', eval = TRUE}
```
